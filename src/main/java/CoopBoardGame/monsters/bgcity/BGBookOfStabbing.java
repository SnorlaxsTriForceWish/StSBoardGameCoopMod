...
public class BGBookOfStabbing extends AbstractBGMonster implements BGDamageIcons {
    ...
    private static final MonsterStrings monsterStrings =
        CardCrawlGame.languagePack.getMonsterStrings("BookOfStabbing");
    ...
    public BGBookOfStabbing() {
        ...
        loadAnimation(
            "images/monsters/theCity/stabBook/skeleton.atlas",
    ...
    public void usePreBattleAction() {
        AbstractDungeon.actionManager.addToBottom(
            (AbstractGameAction) new ApplyPowerAction(
                ...
                (AbstractCreature) this,
                (AbstractPower) new BGPainfulStabsPower((AbstractCreature) this)
            )
        );
    }
            ...
            case 1:
                ...
                AbstractDungeon.actionManager.addToBottom(
                    (AbstractGameAction) new SFXAction(
                        "MONSTER_BOOK_STAB_" + MathUtils.random(0, 3)
                    )
                );
                AbstractDungeon.actionManager.addToBottom(
