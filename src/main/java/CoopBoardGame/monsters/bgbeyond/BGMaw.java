...
public class BGMaw extends AbstractBGMonster implements BGDamageIcons {
    ...
    public BGMaw(float x, float y) {
        ...
        loadAnimation(
            "images/monsters/theForest/maw/skeleton.atlas",
            "images/monsters/theForest/maw/skeleton.json",
            1.0F
        );
        ...
        if (AbstractDungeon.ascensionLevel < 7) this.damage.add(
            new DamageInfo((AbstractCreature) this, 6)
        );
        else this.damage.add(new DamageInfo((AbstractCreature) this, 8));
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case 1:
                ...
                AbstractDungeon.actionManager.addToBottom(
                    (AbstractGameAction) new SFXAction("MAW_DEATH", 0.1F)
                );
                AbstractDungeon.actionManager.addToBottom(
