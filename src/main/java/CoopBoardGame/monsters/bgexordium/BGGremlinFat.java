...
public class BGGremlinFat extends AbstractBGMonster implements BGDamageIcons {
    ...
    private static final MonsterStrings monsterStrings =
        CardCrawlGame.languagePack.getMonsterStrings("GremlinFat");
    ...
    public BGGremlinFat(float x, float y) {
        ...
        loadAnimation(
            "images/monsters/theBottom/fatGremlin/skeleton.atlas",
    ...
    private void playSfx() {
        ...
        if (roll == 0) {
            AbstractDungeon.actionManager.addToBottom(
                (AbstractGameAction) new SFXAction("VO_GREMLINFAT_1A")
            );
        } else if (roll == 1) {
            AbstractDungeon.actionManager.addToBottom(
                (AbstractGameAction) new SFXAction("VO_GREMLINFAT_1B")
            );
        } else {
            AbstractDungeon.actionManager.addToBottom(
                (AbstractGameAction) new SFXAction("VO_GREMLINFAT_1C")
            );
        }
    }
