...
public class GetNextActionPatch {
    ...
    public static void before(AbstractCard c) {
        ...
        if (c != null) {
            ContextPatches.pushTargetContext(
                CardTargetingPatches.CardField.lastHoveredTarget.get(c)
            );
        } else {
    ...
    public static class Patch1 {
        ...
        @SpireInsertPatch(locator = GetNextActionPatch.Patch1.Locator.class, localvars = {})
    ...
    public static class Patch2 {
        ...
        @SpireInsertPatch(locator = GetNextActionPatch.Patch2.Locator.class, localvars = {})
        public static void Insert() {
            after();
        }
