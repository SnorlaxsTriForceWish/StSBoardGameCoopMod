...
public class BGExordium extends AbstractBGDungeon {
    ...
    public static class DungeonMapBossNodePatch {
        ...
        public static void update(DungeonMap __instance) {
            ...
            if (
                ...
                (AbstractDungeon.getCurrMapNode().y == 11 &&
